...
void mks_global_style_init(void) {
    ...
    mks_global.wifi_btn_style.body.opa = LV_OPA_COVER;//Set the background color to be fully opaque
    ...
    mks_global.language_btn_pr_style.body.opa = LV_OPA_COVER;//Set the background color to be fully opaque
    ...
    mks_global.language_btn_rel_style.body.opa = LV_OPA_COVER;//Set the background color to be fully opaque
    ...
    mks_global.mks_test_style.body.opa = LV_OPA_COVER;//Set the background color to be fully opaque
