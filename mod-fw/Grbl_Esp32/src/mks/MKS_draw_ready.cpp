...
static void disp_label(void) {
    ...
    label_for_imgbtn_name(mks_global.mks_src_1, ready_src.ready_label_Control, ready_src.ready_imgbtn_Control, 0, 0, CONTROL_EN);
    label_for_imgbtn_name(mks_global.mks_src_1, ready_src.ready_label_Sculpture, ready_src.ready_imgbtn_Sculpture, 0, 0, SCULPTURE_EN);
    label_for_imgbtn_name(mks_global.mks_src_1, ready_src.ready_label_Tool, ready_src.ready_imgbtn_Tool, 0, 0, TOOL_EN);

    label_for_text(mks_global.mks_src, ready_src.ready_label_mpos, ready_src.ready_img_mpos, 0, 0, LV_ALIGN_OUT_RIGHT_MID, MPOS_EN);
    label_for_text(mks_global.mks_src, ready_src.ready_label_wpos, ready_src.ready_img_wpos, 0, 0, LV_ALIGN_OUT_RIGHT_MID, WPOS_EN);
    ...
    ready_src.ready_label_m_zpos = label_for_text(mks_global.mks_src,   ready_src.ready_label_m_zpos, NULL , 280, 166, LV_ALIGN_IN_TOP_LEFT, "Z:0");
        ...
        if (mks_get_wifi_status() == false){ 
            ready_src.ready_label_wifi_status = label_for_text(mks_global.mks_src, ready_src.ready_label_wifi_status, NULL, 34, 6, LV_ALIGN_IN_TOP_LEFT, "WIFI not connected");
        }else {
            ready_src.ready_label_wifi_status = label_for_text(mks_global.mks_src, ready_src.ready_label_wifi_status, NULL, 34, 6, LV_ALIGN_IN_TOP_LEFT, "WIFI connected");
        }
    #else 
